...
trait Send
{
     ...
     */
    public function sendError($message = 'error', $error = 400, $code = 20001, $data = [], $headers = [], $options = [])
    {
     ...
     */
    public function sendSuccess($data = [], $message = 'success', $code = 20000, $headers = [], $options = [])
    {
